...
class PropertyPosting(models.Model):
    ...
    postingDate = models.DateField(blank=True)
    ...
    roomNumber = models.IntegerField(blank=True)
    ...
    otherFeesAndBills = models.DecimalField(blank=True, max_digits=10, decimal_places=2)
